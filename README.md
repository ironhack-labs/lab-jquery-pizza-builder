...
**Hint:** How could we select the current ingredients? Remember we have a Javascript Selector that allows us to check if an HTML Node contains a certain string :)
